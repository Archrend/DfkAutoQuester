...
def get_required_runes(level, rpc_address, contract_address):
...
def active_attunement_crystals(address, rpc_address, contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def add_attunement_crystal(address, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def start_meditation(hero_id, stat1, stat2, stat3, attunement_crystal_address, private_key, nonce, gas_price_gwei, tx_timeout_seconds, rpc_address, logger,contract_address):
...
def complete_meditation(hero_id, private_key, nonce, gas_price_gwei, tx_timeout_seconds, rpc_address, logger,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
    account = w3.eth.account.privateKeyToAccount(private_key)
    w3.eth.default_account = account.address
...
def get_active_meditations(address, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def get_hero_meditation(hero_id, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def get_meditation(meditation_id, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def hero_to_meditation_id(hero_id, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def profile_active_meditations(address, id, rpc_address,contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
