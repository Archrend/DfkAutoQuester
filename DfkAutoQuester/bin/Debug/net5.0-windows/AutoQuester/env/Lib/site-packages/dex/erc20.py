...
ITEMS_CV = [
	...
	("0x576C260513204392F0eC0bc865450872025CB1cA", "DFKGOLD", "Gold Pile"),
    ...
    ("0xe7a1B580942148451E47b92e95aEB8d31B0acA37", "DFKFROSTDRUM", "Frost Drum"),
    ("0xBcdD90034eB73e7Aec2598ea9082d381a285f63b", "DFKKNAPROOT", "Knaproot"),
    ("0x80A42Dc2909C0873294c5E359e8DF49cf21c74E4", "DFKSHAGGYCAPS", "Shaggy Caps"),
    ("0xc6030Afa09EDec1fd8e63a1dE10fC00E0146DaF3", "DFKSKUNKSHADE", "Skunk Shade"),
    ...
    ("0x3bcb9A3DaB194C6D8D44B424AF383E7Db51C82BD", "DFKFROSTBLOATER", "Frost Bloater"),
    ("0xE7CB27ad646C49dC1671Cb9207176D864922C431", "DFKSPECKLETAIL", "Speckle Tail"),
    ("0x60A3810a3963f23Fa70591435bbe93BF8786E202", "DFKKINGPINCER", "King Pincer"),
    ("0x6513757978E89e822772c16B60AE033781A29A4F", "DFKTHREEEYEDEEL", "Three Eyed Eel"),
	...
	("0x0776b936344DE7bd58A4738306a6c76835ce5D3F", "DFKBLUESTEM", "Bluestem"),
...
def symbol2address(symbol, items):
    symbol = symbol.upper().strip()
    for item in items:
        if item[1] == symbol:
            return item[0]
...
def address2item(address, items):
...
def address2symbol(address, items):
    address = address.upper().strip()
    for item in items:
        if item[0].upper() == address:
            return item[1]
