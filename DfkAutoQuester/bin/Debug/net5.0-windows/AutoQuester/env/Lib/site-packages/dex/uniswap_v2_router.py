...
def weth(rpc_address, contract_address):
    '''
...
def factory(rpc_address, contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def quote(amount_a, reserve_a, reserve_b, rpc_address, contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def get_amount_in(amount_out, reserve_in, reserve_out, rpc_address, contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def get_amount_out(amount_in, reserve_in, reserve_out, rpc_address, contract_address):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
...
def swap_exact_tokens_for_tokens(amount_in, amount_out_min, path, to, deadline, private_key, nonce, gas_price_gwei, tx_timeout_seconds, rpc_address, logger, contract_address):
    '''
...
def swap_exact_tokens_for_eth(amount_in, amount_out_min, path, to, deadline, private_key, nonce, gas_price_gwei, tx_timeout_seconds, rpc_address, logger, contract_address):
    '''
